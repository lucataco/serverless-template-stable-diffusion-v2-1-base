...
This repo gives a basic framework for serving Stable Diffusion v2.1 in production using simple HTTP servers. Does not need a Huggingface token, ready for 1-click deploy
